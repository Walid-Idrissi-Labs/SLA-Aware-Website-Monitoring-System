...
/** Google "G" brand mark (lucide dropped brand icons, so this is inlined). */
export default function GoogleIcon({ className }: Props) {
  return (
    <svg viewBox="0 0 48 48" className={className} aria-hidden="true">
      ...
      <path
        fill="#EA4335"
        d="M24 9.5c3.23 0 6.13 1.11 8.41 3.29l6.31-6.31C34.91 2.73 29.93.5 24 .5A21.99 21.99 0 0 0 4.34 13.62l7.35 5.7C13.42 13.37 18.27 9.5 24 9.5z"
      />
    </svg>
  )
}
